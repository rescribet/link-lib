...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.react = exports.utilities = undefined;
	...
	var _react = _interopRequireWildcard(_components);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PropertyBase = __webpack_require__(4);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function allPropertyTypes(properties) {
	  var props = _LinkedRenderStore.schema['@graph'].filter(function (obj) {
	    return (0, _utilities.propertyIncludes)(obj['owl:sameAs'], properties);
	  }).map(function (obj) {
	    return (0, _utilities.normalizePropery)(obj);
	  });
	    ...
	    value: function expandedProperty(property) {
	      ...
	      if (Array.isArray(prop)) {
	        return prop.map(function (p) {
	          return (0, _LinkedRenderStore.expandProperty)(p);
	        });
	      }
	      return [(0, _LinkedRenderStore.expandProperty)(prop)];
	    }
	  }, {
	    key: 'render',
